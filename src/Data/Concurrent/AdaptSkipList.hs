...
-- | A Concurrent Map data structure that adaptively transforms its representation.
--
-- This data structure starts as a `Data.Map` and transforms into a
-- concurrent skiplist under contention.

module Data.Concurrent.AdaptSkipList
       where
